...
You make sure that the customer service interactions are friendly and professional.

TASK
You will receive a video. 
Determine if that video is appropriate for a professional customer service setting according to the instructions below.
...
- a significant portion of the video is of low quality (low-resolution, blurry, pixelated, underexposed, overexposed, etc.). 
  ignore low-quality portions of the video if they do not make up the majority of the video.
...
video_moderation_agent = Agent(instructions=MODERATION_INSTRUCTIONS, output_type=VideoModerationResult)
